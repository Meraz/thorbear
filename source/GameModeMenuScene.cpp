...
void GameModeMenuScene::Initialize(RenderComponentInterface* p_renderComponentInterface)
{
	...
	m_button.push_back(new Button(BoundingBox(150.0f, 150.0f, 70, 30, 50), this, &GameModeMenuScene::ChangeCurrentState, SceneState::GAME, START_CAMPAIGN, p_renderComponentInterface, CAMPAIGN));
	m_button.push_back(new Button(BoundingBox(350.0f, 150.0f, 70, 30, 50), this, &GameModeMenuScene::ChangeCurrentState, SceneState::GAME,	START_SURVIVAL, p_renderComponentInterface, SURVIVAL));
	m_button.push_back(new Button(BoundingBox(250.0f, 50.0f,  70, 30, 50), this, &GameModeMenuScene::ChangeCurrentState, SceneState::MAIN_MENU, MAINMENU, p_renderComponentInterface, RETURN));
}
