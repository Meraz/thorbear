...
void MainMenuScene::Initialize(RenderComponentInterface* p_renderComponentInterface)
{
	...
	m_button.push_back(new Button(BoundingBox2D(100, 75,  50, 50), this, &MainMenuScene::ChangeCurrentState, SceneState::HIGHSCORE, GameType::NOT_SPECIFIED, p_renderComponentInterface, BUTTON2));
	m_button.push_back(new Button(BoundingBox2D(100, 50,  50, 50), this, &MainMenuScene::ChangeCurrentState, SceneState::EXIT, GameType::NOT_SPECIFIED, p_renderComponentInterface, BUTTON3));
